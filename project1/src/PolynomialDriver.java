...
public class PolynomialDriver {
	static public void showInfo(Polynomial p) {
		p.displayPolynomial();
		System.out.println(p.displayPolynomial());
	...
	static public void main(String[] args) {
		...
		Polynomial a = new ArrayPolynomial();
		System.out.print("p = ");
		showInfo(p);
...
//		System.out.print( "p = " + p.getCoefficient(4) + "X^ + " + 
//								   p.getCoefficient(3) + "X^ + " + 
//								   p.getCoefficient(0) + "\n");
...
//
		...
		System.out.print(
				"p = " + p.getCoefficient(6) + "X^ + " +
						 p.getCoefficient(4) + "X^ + " +
						 p.getCoefficient(3) + "X^ + " + 
						 p.getCoefficient(0) + "\n");
		showInfo(p);
//
...
//		Polynomial q = new ArrayPolynomial(k);
...
//		// Test case M.1	
//		System.out.println("\nTest case M.1:");							
//		Polynomial s = new ArrayPolynomial(q);
//		Polynomial t = new ArrayPolynomial(q);
